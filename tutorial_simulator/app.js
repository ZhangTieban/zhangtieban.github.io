...
const tutorialProfileExamples = {
  normal: {
    ...
    note: "峰值夠高 + 明顯下降",
    points: [
      0, 500, 1300, 2600, 4300, 6300, 8200, 9900,
      11300, 12200, 12400, 12100, 11600, 10800, 9900, 8800,
      7600, 6400, 5200, 4100, 3100, 2200, 1500, 900,
      480, 220, 80, 0, 0, 0, 0, 0
    ]
  },
  low: {
    label: "範例：低速發射",
  ...
  high: {
    ...
    threshold: 19000,
    points: [
      0, 800, 2200, 4800, 8400, 12800, 16600, 19300,
      20200, 20700, 20300, 19600, 18400, 16600, 14400, 12200,
      9800, 7600, 5600, 3800, 2500, 1500, 800, 350,
      120, 0, 0, 0, 0, 0, 0, 0
    ]
  },
  abnormal: {
    ...
    highlightDrop: true,
    points: [
      0, 700, 1900, 4100, 7200, 9800, 11700, 11100,
      900, 620, 480, 380, 310, 250, 200, 160,
      120, 90, 65, 45, 30, 18, 8, 0,
      0, 0, 0, 0, 0, 0, 0, 0
    ]
  }
};
